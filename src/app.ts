...
import legalDocsRoutes from './routes/legal-docs.routes';
...
import forecastCategoryRoutes from './routes/forecast-category.routes';
...
app.use('/api/legal-docs', legalDocsRoutes);
...
app.use('/api/forecast-categories', forecastCategoryRoutes);
